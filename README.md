...
📌 An end-to-end data analysis project using weekly supplement sales data  
📌 Performed data cleaning, transformation, aggregation, and visualization  
📌 Goal: Understand sales performance, profitability, customer returns, and seasonal trends to support data-driven decisions
...
✔ Compare sales performance across locations and platforms  
✔ Study the impact of discounts on revenue  
✔ Analyze return rates and their effect on net revenue  
...
🟡 Platform-wise and location-wise performance  
🟡 Top 5 products by revenue  
🟡 Return rate analysis by product category  
🟡 Discount vs revenue relationship  
🟡 Correlation analysis of key sales metrics  
